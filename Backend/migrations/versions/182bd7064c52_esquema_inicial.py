...
Revision ID: 182bd7064c52
Revises: 
Create Date: 2025-08-06 12:54:17.104556
...
def upgrade():
    ...
    sa.CheckConstraint("estado_pago IN ('Pendiente','Pagado','Cancelado','En revisión')", name='chk_estado_pago'),
    sa.ForeignKeyConstraint(['alumno_id'], ['alumnos.id'], ),
